...
class Pregunta2Page extends StatefulWidget {
  Pregunta2Page({Key key}) : super(key: key);

  @override
  _Pregunta2PageState createState() => _Pregunta2PageState();
}

class _Pregunta2PageState extends State<Pregunta2Page> {
  @override
